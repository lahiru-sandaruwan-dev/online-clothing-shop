...
var product1: ProductModel = .init(title: "Casual Extended Sleeves Color Block Women Orange Top", price: 255, description: "Orange and grey regular top Colourblocked V-neck, long, extended sleeves Waist tie-ups detail Knitted", images: ["P01_01", "P01_02", "P01_03", "P01_04"], category: .TShirt, gender: .Female)
